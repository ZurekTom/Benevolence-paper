    ...
    public static void main(String[] args) {
        ...
        system.tell(
                AgentRequestMessage.apply(
                        toSeq(List.of(
                                        new AgentRequest(asl.agentX_companion.create(), "agentX",1), 
                                        new AgentRequest(asl.tomY_companion.create(), "tomY",1),
                                        new AgentRequest(asl.tomZ_companion.create(), "tomZ",1)
                                )
                        ),
                        system
                )
